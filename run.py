...
class Window(QMainWindow):
    ...
    def on_show_detect_window(self):
        ...
        self.btn_prepare_dataset.setVisible(False)
        self.btn_train.setVisible(False)
        self.btn_load_class_labels.setVisible(True)
    ...
    def on_detect(self):
        ...
        self.thread_simrdwn.sig1.connect(
            self.on_display_msg)
        self.thread_simrdwn.outputs.connect(
            self.on_display_result_image)
        # self.thread_prep_data.sig3.connect(
        #     self.on_image_preprocessed_result)
        self.thread_simrdwn.args.mode = 'test'
        # self.thread_simrdwn.args.yolt_train_images_list_file_tot='yolt_train_list.txt'
        # self.thread_simrdwn.args.train_model_path='/media/tunguyen/DEVS/DeepLearning/simrdwn/results/train_yolt2_dense_cars_2019_11_01_19-08-03'
        # self.thread_simrdwn.args.weight_file_tot='/media/tunguyen/DEVS/DeepLearning/simrdwn/results/train_yolt2_dense_cars_2019_11_01_19-08-03/ave_dense_1000_tmp.weights'

        self.thread_simrdwn.args.keep_test_slices = 1

        self.textedit.append('weight_file_tot: ' +
                             self.thread_simrdwn.args.weight_file_tot)
        self.textedit.append(
            'testims_dir_tot: '+self.thread_simrdwn.args.testims_dir_tot)
        self.textedit.append('yolt_cfg_file_in: ' +
                             self.thread_simrdwn.args.yolt_cfg_file_in)
        # self.textedit.append('yolt_train_images_list_file_tot: '+self.thread_simrdwn.args.yolt_train_images_list_file_tot)
